...
ADDONTITLE     = 'Bradleys Wizard'
EXCLUDES       = [ADDON_ID, 'repository.bradleyrepo']
# Text File with build info in it.
BUILDFILE      = 'http://bradl79.x10.mx/bradleyswizard/builds.txt'
...
ADVANCEDFILE   = 'http://bradl79.x10.mx/bradleyswizard/advancedsettings/advanced.txt'
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']Bradleys Wizard[/COLOR])[/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR][/I]'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing Bradleys wizard.'
